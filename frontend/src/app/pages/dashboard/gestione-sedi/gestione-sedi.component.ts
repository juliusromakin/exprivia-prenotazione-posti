...
export class GestioneSediComponent implements OnInit {
  locations: Sede[] = [
    { 
      ...
      edifici: [
        { name: 'Edificio 1', address: 'Via Molfetta, 1', numFloors: 3, coordX: 10, coordY: 10 },
        { name: 'Edificio 2', address: 'Via Molfetta, 2', numFloors: 3, coordX: 20, coordY: 20 },
        { name: 'Edificio 3', address: 'Via Molfetta, 3', numFloors: 3, coordX: 30, coordY: 30 }
      ]
    },
    { 
      id: 2, 
      ...
      edifici: [
        { name: 'Sede Roma 1', address: 'Via Bufalotta, 104', numFloors: 1, coordX: 50, coordY: 50 },
        { name: 'Sede Roma 2', address: 'Via Tiburtina, 40', numFloors: 5, coordX: 60, coordY: 60 }
      ]
    }
  ];
